...
// $insert polymorphicOpAssignDecl
        SType &operator=(unsigned char const &value);
        SType &operator=(unsigned char &&tmp);
...
inline SType &SType::operator=(unsigned char const &value)
{
    assign< Tag_::UCHAR >(value);
    return *this;
}
inline SType &SType::operator=(unsigned char &&tmp)
{
    assign< Tag_::UCHAR >(std::move(tmp));
    return *this;
}
