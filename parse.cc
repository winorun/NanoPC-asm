// Generated by Bisonc++ V6.02.04 on Wed, 21 Jul 2021 01:47:55 +0700
...
PI_ const s_productionInfo[] = 
{
     ...
     {288, 2}, // 1: startrule ->  startrule commandString
     {288, 1}, // 2: startrule ->  commandString
     {290, 1}, // 3: reg (REG) ->  REG
     {289, 3}, // 4: commandString (DEF) ->  DEF identifier number
     {289, 1}, // 5: commandString (NEW_LINE) ->  NEW_LINE
     {289, 3}, // 6: commandString (NEW_LINE) ->  label NEW_LINE command
     {289, 2}, // 7: commandString ->  label command
     {289, 1}, // 8: commandString ->  command
     {289, 2}, // 9: commandString (START) ->  START number
     {291, 1}, // 10: command ->  command_1
     {291, 2}, // 11: command ->  command_2 opt
     {291, 2}, // 12: command ->  command_2 identifier
     {291, 4}, // 13: command (COMMA) ->  command_3 opt COMMA opt
     {291, 4}, // 14: command (COMMA) ->  command_3 opt COMMA identifier
     {291, 1}, // 15: command ->  db
     {292, 1}, // 16: opt ->  reg
     {292, 1}, // 17: opt ->  number
     {292, 2}, // 18: opt (REG_LINK) ->  REG_LINK reg
     {292, 2}, // 19: opt (REG_LINK_LINK) ->  REG_LINK_LINK reg
     {292, 1}, // 20: opt ->  value
     {293, 1}, // 21: word (WORD) ->  WORD
     {294, 1}, // 22: value (VALUE) ->  VALUE
     {295, 1}, // 23: label (LABEL) ->  LABEL
     {296, 2}, // 24: db (DB) ->  DB word
     {296, 2}, // 25: db (DB) ->  DB number
     {296, 3}, // 26: db (COMMA) ->  db COMMA number
     {297, 1}, // 27: number (NUMBER_HEX) ->  NUMBER_HEX
     {297, 1}, // 28: number (NUMBER_DEC) ->  NUMBER_DEC
     {297, 1}, // 29: number (NUMBER_BIN) ->  NUMBER_BIN
     {297, 1}, // 30: number (NUMBER_CHAR) ->  NUMBER_CHAR
     {298, 1}, // 31: identifier (IDENTIFIER) ->  IDENTIFIER
     {299, 1}, // 32: command_1 (COMMAND_1) ->  COMMAND_1
     {300, 1}, // 33: command_2 (COMMAND_2) ->  COMMAND_2
     {301, 1}, // 34: command_3 (COMMAND_3) ->  COMMAND_3
     {302, 1}, // 35: startrule_$ ->  startrule
};
...
#line 19 "grammar"
        {
         d_val_.assign<Tag_::UCHAR>(map_reg[d_scanner.matched()]);
         }
        break;
...
#line 25 "grammar"
        {
         std::cout << vs_(-1).get<Tag_::STRING>() << " = " << (int)vs_(0).get<Tag_::UCHAR>() << "\n";
         map_value[vs_(-1).get<Tag_::STRING>()] = vs_(0).get<Tag_::UCHAR>();
         }
        break;
...
#line 36 "grammar"
        {
         line ++;
         map_label[vs_(-2).get<Tag_::STRING>()]=vs_(0).get<Tag_::UCHAR>();
         std::cout << "label: " << vs_(-2).get<Tag_::STRING>() << " = " << (int)vs_(0).get<Tag_::UCHAR>() << std::endl;
         }
        break;
...
#line 43 "grammar"
        {
         map_label[vs_(-1).get<Tag_::STRING>()]=vs_(0).get<Tag_::UCHAR>();
         std::cout << "label: " << vs_(-1).get<Tag_::STRING>() << " = " << (int)vs_(0).get<Tag_::UCHAR>() << std::endl;
         }
        break;
...
#line 51 "grammar"
        {
         g_programm.resize(vs_(0).get<Tag_::UCHAR>(),0); 
         }
        break;
...
#line 57 "grammar"
        {
         d_val_.assign<Tag_::UCHAR>(g_programm.size());
         std::cout << std::hex << g_programm.size() << " command: " << std::hex << (int)vs_(0).get<Tag_::UCHAR>() << "\n";
         g_programm.push_back(vs_(0).get<Tag_::UCHAR>());
         }
        break;
...
#line 64 "grammar"
        {
         ...
         date = vs_(0).get<Tag_::INT>() % 0x100;
         type = vs_(0).get<Tag_::INT>() / 0x100;
         cmd = vs_(-1).get<Tag_::UCHAR>()+type;
...
#line 76 "grammar"
        {
         d_val_.assign<Tag_::UCHAR>(g_programm.size());
         g_programm.push_back(vs_(-1).get<Tag_::UCHAR>());
         map_label_list[vs_(0).get<Tag_::STRING>()].push_back(g_programm.size());
...
#line 85 "grammar"
        {
         ...
         opt_1_data = vs_(-2).get<Tag_::INT>() % 0x100;
         opt_1_type = vs_(-2).get<Tag_::INT>() / 0x100;
         opt_2_data = vs_(0).get<Tag_::INT>() % 0x100;
         opt_2_type = vs_(0).get<Tag_::INT>() / 0x100;
         opt_2_type = opt_2_type * 0b100;
         cmd = vs_(-3).get<Tag_::UCHAR>()+opt_2_type+opt_1_type;
...
#line 101 "grammar"
        {
         d_val_.assign<Tag_::UCHAR>(g_programm.size());
         unsigned char date,type,cmd;
         date = vs_(-2).get<Tag_::INT>() % 0x100;
         type = vs_(-2).get<Tag_::INT>() / 0x100;
         cmd = vs_(-3).get<Tag_::UCHAR>()+type;
         g_programm.push_back(cmd);
         g_programm.push_back(date); 
         map_label_list[vs_(0).get<Tag_::STRING>()].push_back(g_programm.size());
...
#line 120 "grammar"
        {
         d_val_.assign<Tag_::INT>(vs_(0).get<Tag_::UCHAR>()+0x100);
         }
        break;
...
#line 125 "grammar"
        {
         d_val_.assign<Tag_::INT>(vs_(0).get<Tag_::UCHAR>());
         }
        break;
...
#line 130 "grammar"
        {
         d_val_.assign<Tag_::INT>(vs_(0).get<Tag_::UCHAR>()+0x200);
         }
        break;
...
#line 135 "grammar"
        {
         d_val_.assign<Tag_::INT>(vs_(0).get<Tag_::UCHAR>()+0x300);
         }
        break;
...
#line 140 "grammar"
        {
         if(map_value.count(vs_(0).get<Tag_::STRING>()) == 1)
         d_val_.assign<Tag_::INT>(map_value[vs_(0).get<Tag_::STRING>()]);
         else
         d_val_.assign<Tag_::INT>(0);
         }
        break;
...
#line 150 "grammar"
        {
         d_val_.assign<Tag_::STRING>(d_scanner.matched().substr(1, d_scanner.matched().length() - 2));
         }
        break;
...
#line 156 "grammar"
        {
         d_val_.assign<Tag_::STRING>(d_scanner.matched().substr(1, d_scanner.matched().length() - 1));
         }
        break;
...
#line 162 "grammar"
        {
         d_val_.assign<Tag_::STRING>(d_scanner.matched().substr(0, d_scanner.matched().length() - 1));
         }
        break;
...
#line 168 "grammar"
        {
         d_val_.assign<Tag_::UCHAR>(g_programm.size());
         for(auto ch:vs_(0).get<Tag_::STRING>()){
...
#line 190 "grammar"
        {
         d_val_.assign<Tag_::UCHAR>(std::stoi(d_scanner.matched(),0,16));
         }
        break;
...
#line 195 "grammar"
        {
         d_val_.assign<Tag_::UCHAR>(std::stoi(d_scanner.matched()));
         }
        break;
...
#line 200 "grammar"
        {
         d_val_.assign<Tag_::UCHAR>(std::stoi(std::string(d_scanner.matched()).erase(0, 2),0,2));
         }
        break;
...
#line 205 "grammar"
        {
         d_val_.assign<Tag_::UCHAR>((unsigned char)d_scanner.matched().c_str()[1]);
         }
        break;
...
#line 217 "grammar"
        {
         d_val_.assign<Tag_::UCHAR>(map_command[d_scanner.matched()]);
         }
        break;
