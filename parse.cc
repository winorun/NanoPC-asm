// Generated by Bisonc++ V6.02.04 on Tue, 17 Aug 2021 10:31:30 +0700
...
PI_ const s_productionInfo[] = 
{
     ...
     {288, 2}, // 3: startrule (errTok_) ->  errTok_ NEW_LINE
     {290, 1}, // 4: reg (REG) ->  REG
     {289, 3}, // 5: commandString (DEF) ->  DEF identifier number
     {289, 1}, // 6: commandString (NEW_LINE) ->  NEW_LINE
     {289, 3}, // 7: commandString (NEW_LINE) ->  label NEW_LINE command
     {289, 2}, // 8: commandString ->  label command
     {289, 1}, // 9: commandString ->  command
     {289, 2}, // 10: commandString (START) ->  START number
     {291, 1}, // 11: command ->  command_1
     {291, 2}, // 12: command ->  command_2 opt
     {291, 2}, // 13: command ->  command_2 identifier
     {291, 4}, // 14: command (COMMA) ->  command_3 opt COMMA opt
     {291, 4}, // 15: command (COMMA) ->  command_3 opt COMMA identifier
     {291, 1}, // 16: command ->  db
     {292, 1}, // 17: opt ->  reg
     {292, 1}, // 18: opt ->  number
     {292, 2}, // 19: opt (REG_LINK) ->  REG_LINK reg
     {292, 2}, // 20: opt (REG_LINK_LINK) ->  REG_LINK_LINK reg
     {292, 1}, // 21: opt ->  value
     {293, 1}, // 22: word (WORD) ->  WORD
     {294, 1}, // 23: value (VALUE) ->  VALUE
     {295, 1}, // 24: label (LABEL) ->  LABEL
     {296, 2}, // 25: db (DB) ->  DB word
     {296, 2}, // 26: db (DB) ->  DB number
     {296, 3}, // 27: db (COMMA) ->  db COMMA number
     {297, 1}, // 28: number (NUMBER_HEX) ->  NUMBER_HEX
     {297, 1}, // 29: number (NUMBER_DEC) ->  NUMBER_DEC
     {297, 1}, // 30: number (NUMBER_BIN) ->  NUMBER_BIN
     {297, 1}, // 31: number (NUMBER_CHAR) ->  NUMBER_CHAR
     {298, 1}, // 32: identifier (IDENTIFIER) ->  IDENTIFIER
     {299, 1}, // 33: command_1 (COMMAND_1) ->  COMMAND_1
     {300, 1}, // 34: command_2 (COMMAND_2) ->  COMMAND_2
     {301, 1}, // 35: command_3 (COMMAND_3) ->  COMMAND_3
     {302, 1}, // 36: startrule_$ ->  startrule
};
...
#line 61 "grammar"
        {
         ...
         std::cout << std::hex << g_programm.size() << " command: " << (int)vs_(0).get<Tag_::UCHAR>() << "\n";
