// Generated by Bisonc++ V6.02.04 on Tue, 20 Jul 2021 02:39:40 +0700
...
PI_ const s_productionInfo[] = 
{
     ...
     {283, 2}, // 1: startrule ->  startrule commandString
     {283, 1}, // 2: startrule ->  commandString
     {285, 1}, // 3: reg (REG) ->  REG
     {284, 3}, // 4: commandString (DEF) ->  DEF identifier number
     {284, 1}, // 5: commandString (NEW_LINE) ->  NEW_LINE
     {284, 3}, // 6: commandString (NEW_LINE) ->  label NEW_LINE command
     {284, 2}, // 7: commandString ->  label command
     {284, 1}, // 8: commandString ->  command
     {286, 1}, // 9: command ->  command_1
     {286, 2}, // 10: command ->  command_2 opt
     {286, 4}, // 11: command (COMMA) ->  command_3 opt COMMA opt
     {286, 1}, // 12: command ->  db
     {288, 1}, // 13: opt ->  reg
     {288, 1}, // 14: opt ->  number
     {288, 2}, // 15: opt (REG_LINK) ->  REG_LINK reg
     {288, 2}, // 16: opt (REG_LINK_LINK) ->  REG_LINK_LINK reg
     {289, 1}, // 17: word (WORD) ->  WORD
     {290, 1}, // 18: label (LABEL) ->  LABEL
     {287, 2}, // 19: db (DB) ->  DB word
     {287, 2}, // 20: db (DB) ->  DB number
     {287, 3}, // 21: db (COMMA) ->  db COMMA number
     {291, 1}, // 22: number (NUMBER_HEX) ->  NUMBER_HEX
     {291, 1}, // 23: number (NUMBER_DEC) ->  NUMBER_DEC
     {291, 1}, // 24: number (NUMBER_BIN) ->  NUMBER_BIN
     {291, 1}, // 25: number (NUMBER_CHAR) ->  NUMBER_CHAR
     {292, 1}, // 26: identifier (IDENTIFIER) ->  IDENTIFIER
     {293, 1}, // 27: command_1 (COMMAND_1) ->  COMMAND_1
     {294, 1}, // 28: command_2 (COMMAND_2) ->  COMMAND_2
     {295, 1}, // 29: command_3 (COMMAND_3) ->  COMMAND_3
     {296, 1}, // 30: startrule_$ ->  startrule
};
